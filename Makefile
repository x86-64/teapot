...
SOURCES = $(FEATURES_ENABLED) $(PROGRAM).c gcode_parse.c gcode_process.c dda.c dda_maths.c dda_queue.c timer.c temp.c sermsg.c debug.c sersendf.c heater.c pinio.c home.c crc.c delay.c
